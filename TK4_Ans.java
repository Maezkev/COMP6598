...
public class TK4_Ans {
    ...
    public static class Calculate {
        static public void input() {
            ...
            System.out.println("Selamat Datang diProgram Simulasi");
            ...
            case 6:
                ...
                break;
            default:
                System.out.println("Tolong pilih lah yang di menu !!!!");
                break;
            }
        }
        ...
        public static void selectDisplay(int[] random_number, String extreme, int b, int temp_min) // printing selection
                                                                                                   // method
        {
            for (int k = 0; k <= random_number.length - 1; k++) {
                if (k == temp_min) {
